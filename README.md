...
- Multi-page character and lore database with custom CSS styling per entry
- Deployed via GitHub Pages | Built with **HTML, CSS, JavaScript**
- **[View the live site →](https://gearlessjoe25.github.io/motw/)** | **[Source repo →](https://github.com/gearlessjoe25/motw)**
